...
public class Modelsilverhat<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "silverhat"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, -8.1F, -4.5F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.1F, 0.5F));

		PartDefinition silverhead = head.addOrReplaceChild("silverhead",
				CubeListBuilder.create().texOffs(0, 32)
						.addBox(-6.0F, -6.0F, -4.5F, 12.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)).texOffs(0, 32)
		...
		PartDefinition neck = silverhead.addOrReplaceChild("neck",
				CubeListBuilder.create().texOffs(0, 48)
						.addBox(-5.0F, -3.0F, -4.2F, 10.0F, 6.0F, 4.0F, new CubeDeformation(0.5F)).texOffs(0, 15)
		...
		PartDefinition head2 = neck.addOrReplaceChild("head2",
				CubeListBuilder.create().texOffs(0, 25)
						.addBox(-6.0F, -4.0F, 1.5F, 12.0F, 5.0F, 1.0F, new CubeDeformation(1.0F)).texOffs(1, 59)
		...
		PartDefinition bodyback = silverhead.addOrReplaceChild("bodyback",
				CubeListBuilder.create().texOffs(32, 52)
						.addBox(-5.0F, 0.5F, 0.5F, 10.0F, 6.0F, 6.0F, new CubeDeformation(0.5F)).texOffs(0, 15)
		...
		PartDefinition bodyback2 = bodyback.addOrReplaceChild("bodyback2",
				CubeListBuilder.create().texOffs(40, 44)
						.addBox(-4.0F, 0.5F, 0.5F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.5F)).texOffs(0, 25)
		...
		PartDefinition bodyback3 = bodyback2.addOrReplaceChild("bodyback3",
				CubeListBuilder.create().texOffs(44, 38)
						.addBox(-3.0F, 0.5F, 0.5F, 6.0F, 2.0F, 4.0F, new CubeDeformation(0.5F)).texOffs(0, 25)
		...
		PartDefinition bodytail = bodyback3
				.addOrReplaceChild("bodytail",
						CubeListBuilder.create().texOffs(52, 32).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 4.0F,
