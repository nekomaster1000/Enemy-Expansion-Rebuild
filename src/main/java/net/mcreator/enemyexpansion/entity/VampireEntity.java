...
import net.mcreator.enemyexpansion.procedures.VampireTickProcedure;
...
public class VampireEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(VampireEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(VampireEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(VampireEntity.class, EntityDataSerializers.STRING);
	...
	public VampireEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.VAMPIRE.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "vampire");
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, Zombie.class, false, false));
	...
	public static void init() {
		SpawnPlacements.register(EnemyexpansionModEntities.VAMPIRE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(VampireEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
