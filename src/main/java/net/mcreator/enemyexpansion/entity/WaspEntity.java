...
public class WaspEntity extends Monster implements IAnimatable {
	...
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(WaspEntity.class, EntityDataSerializers.STRING);
	...
	public boolean hurt(DamageSource source, float amount) {
		WaspHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	public void baseTick() {
		super.baseTick();
		WaspTickProcedure.execute(this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(WaspEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
