...
import net.mcreator.enemyexpansion.procedures.DireleapFireProcedure;
import net.mcreator.enemyexpansion.procedures.DireLeapProcedure;
import net.mcreator.enemyexpansion.procedures.DireKillProcedure;
...
public class DirewolfEntity extends Monster implements IAnimatable {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, Skeleton.class, false, false));
	...
	public boolean hurt(DamageSource source, float amount) {
		DireleapFireProcedure.execute(this);
	...
	public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
		...
		DireKillProcedure.execute(this);
	}

	@Override
	public void baseTick() {
		super.baseTick();
		DireLeapProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
