...
public class MeatureEntity extends TamableAnimal implements IAnimatable {
	...
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MeatureEntity.class, EntityDataSerializers.STRING);
	...
	public MeatureEntity(EntityType<MeatureEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "meature");
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		MeatureSpawnProcedure.execute(this);
		return retval;
	}
	...
	public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
		...
		MeatureKillsProcedure.execute(this.level, this);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		MeatureEntity retval = EnemyexpansionModEntities.MEATURE.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MeatureEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
