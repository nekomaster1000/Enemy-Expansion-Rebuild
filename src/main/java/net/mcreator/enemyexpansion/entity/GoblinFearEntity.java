...
public class GoblinFearEntity extends Monster {
	public GoblinFearEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.GOBLIN_FEAR.get(), world);
	}
