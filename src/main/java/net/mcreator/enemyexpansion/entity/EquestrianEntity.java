...
public class EquestrianEntity extends Monster implements IAnimatable {
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "equestrian");
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		EquestrianHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	...
	public static void init() {
		SpawnPlacements.register(EnemyexpansionModEntities.EQUESTRIAN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
