...
import net.mcreator.enemyexpansion.procedures.GoblinHurtProcedure;
...
public class GoblinEntity extends Monster implements IAnimatable {
	...
	public GoblinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.GOBLIN.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "goblin_thief");
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, GoblinFearEntity.class, (float) 6, 1.3, 2));
		this.goalSelector.addGoal(2, new AvoidEntityGoal<>(this, IronGolem.class, (float) 6, 2, 1.2));
	...
	public static void init() {
		SpawnPlacements.register(EnemyexpansionModEntities.GOBLIN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
