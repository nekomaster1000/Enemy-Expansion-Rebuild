...
public class SilverqueenattackingEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SilverqueenattackingEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SilverqueenattackingEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SilverqueenattackingEntity.class, EntityDataSerializers.STRING);
	...
	public boolean hurt(DamageSource source, float amount) {
		SilverqueenParryProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	...
	public static void init() {
		SpawnPlacements.register(EnemyexpansionModEntities.SILVERQUEENATTACKING.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(SilverqueenattackingEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
