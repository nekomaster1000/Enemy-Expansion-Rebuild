...
import net.mcreator.enemyexpansion.procedures.DroneSpawnProcedure;
import net.mcreator.enemyexpansion.init.EnemyexpansionModEntities;

import javax.annotation.Nullable;

public class DroneEntity extends Monster implements IAnimatable {
	...
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DroneEntity.class, EntityDataSerializers.STRING);
	...
	public DroneEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.DRONE.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "wasp_drone");
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		DroneSpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
