...
public class FlutterflyEntity extends Monster implements IAnimatable {
	...
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FlutterflyEntity.class, EntityDataSerializers.STRING);
	...
	public FlutterflyEntity(EntityType<FlutterflyEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "flutterfly");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new Goal() {
			...
			public boolean canContinueToUse() {
				return FlutterflyEntity.this.getMoveControl().hasWanted() && FlutterflyEntity.this.getTarget() != null && FlutterflyEntity.this.getTarget().isAlive();
			}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.bat.loop"));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		FlutterflyHurtProcedure.execute(this.level, this, source.getEntity());
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		FlutterRightClickedProcedure.execute(world, x, y, z, entity, sourceentity, itemstack);
		return retval;
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(FlutterflyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
