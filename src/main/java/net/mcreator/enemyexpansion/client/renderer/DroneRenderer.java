...
import net.mcreator.enemyexpansion.entity.model.DroneModel;
...
public class DroneRenderer extends GeoEntityRenderer<DroneEntity> {
	...
	@Override
	public RenderType getRenderType(DroneEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
