...
import net.mcreator.enemyexpansion.entity.model.LadybugModel;
...
public class LadybugRenderer extends GeoEntityRenderer<LadybugEntity> {
	...
	@Override
	public RenderType getRenderType(LadybugEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
