...
public class EnemyexpansionModItems {
	...
	public static final RegistryObject<Item> ASSASSIN_SPAWN_EGG = REGISTRY.register("assassin_spawn_egg", () -> new ForgeSpawnEggItem(EnemyexpansionModEntities.ASSASSIN, -10066330, -13421773, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
