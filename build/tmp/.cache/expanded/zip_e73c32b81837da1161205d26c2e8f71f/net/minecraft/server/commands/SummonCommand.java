      ...
      if (!Level.isInSpawnableBounds(blockpos)) {
         ...
         if (entity == null) {
            ...
            if (p_138825_ && entity instanceof Mob) {
               if (!net.minecraftforge.event.ForgeEventFactory.doSpecialSpawn((Mob)entity, p_138821_.getLevel(), (float)entity.getX(), (float)entity.getY(), (float)entity.getZ(), null, MobSpawnType.COMMAND))
