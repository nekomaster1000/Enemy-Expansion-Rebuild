      ...
      Thread thread = new Thread("Server Connector #" + UNIQUE_THREAD_ID.incrementAndGet()) {
         public void run() {
            ...
            try {
               ...
               ConnectScreen.this.connection.send(new ServerboundHelloPacket(p_169265_.getUser().getName(), completablefuture.join(), Optional.ofNullable(p_169265_.getUser().getProfileId())));
               ...
               p_169265_.execute(() -> {
                  p_169265_.setScreen(new DisconnectedScreen(ConnectScreen.this.parent, CommonComponents.CONNECT_FAILED, Component.translatable("disconnect.genericReason", s)));
               });
            }
